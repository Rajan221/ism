...
function Navbar() {
  return (
    <div
      className=" flex justify-between items-center bg-slate-100 text-black p-3 sticky top-0 z-30 px-20"
      id="navbar"
    >
      <div>
        <Image src={logo} height={50} width={50} />
      </div>
      <div className="flex gap-7 text-slate-600 font-semibold" id="navLinks">
